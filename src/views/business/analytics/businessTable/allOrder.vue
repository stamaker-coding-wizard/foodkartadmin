<template>
    <div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody style="text-align:center;">
                                    ...
                                    <td>
                                        <span :class="day.status === 'Completed' ? 'badge badge-success' : 'badge badge-danger'">
                                        {{ day.status }}
                                        </span>
                                    </td>
                                    <td>{{ day.payment }}</td>
        ...
        <b-modal v-model="showEditModal" title="Edit Row">
            ...
            <div class="form-group">
                ...
                <select v-model="editRowData.status" class="form-control" id="editStatus">
                    ...
                    <option value="Restituted">Restituted</option>
                </select>
            </div>
        ...
        <b-modal v-model="showAllOrderChart" size="lg">
          <allOrderChart/>
        </b-modal>
    </div>
</template>
...
import allOrderChart from './chart/allOrder.vue';
...
export default {
  ...
  data() {
    return {
      ...
      showAllOrderChart: false, //Control chart modal visibility
