<template>
    <div>
                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div style="display: flex; justify-content:space-between; align-items:center;">
                            <h4 class="card-title mb-3">Completed</h4>
        ...
        <b-modal v-model="showCompletedChart" size="lg">
            <CompletedChart/>
        </b-modal>
    </div>
</template>
...
import CompletedChart from './chart/completed.vue';
...
export default {
  ...
  data() {
    return {
      ...
      showCompletedChart: false, // Control Chartbox
