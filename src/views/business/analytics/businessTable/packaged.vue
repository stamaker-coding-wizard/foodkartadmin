<template>
    <div>
                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div style="display: flex; justify-content:space-between; align-items:center;">
                            <h4 class="card-title mb-3">Packaged </h4>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody style="text-align:center;">
                                    ...
                                    <td>
                                        <span :class="day.status === 'Packaged' ? 'badge badge-danger' : 'badge badge-success'">
                                        {{ day.status }}
                                        </span>
                                    </td>
                                    <td>{{ day.payment }}</td>
        ...
        <!--Adding ChatBox Modal-->
        <b-modal v-model="showPackagedChart" size="lg">
            <PackagedChart/>
        </b-modal>
    </div>
</template>
...
import PackagedChart from './chart/packaged.vue';
...
export default {
  ...
  data() {
    return {
      ...
      showPackagedChart: false, //Control chart modal visibility
