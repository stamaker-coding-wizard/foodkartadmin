<template>
    <div>
                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div style="display: flex; justify-content:space-between; align-items:center;">
                            <h4 class="card-title mb-3">Approved</h4>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody style="text-align:center;">
                                    ...
                                    <td>
                                        <span :class="day.status === 'Approved' ? 'badge badge-success' : 'badge badge-danger' ">
                                        {{ day.status }}
                                        </span>
                                    </td>
                                    <td>{{ day.payment }}</td>
        ...
        <!--Adding Chart Modal -->
        <b-modal v-model="showApprovedChat" size="lg">
          <ApprovedChat/>
        </b-modal>
    </div>
</template>
...
import ApprovedChat from "./chat/Approved.vue";
...
export default {
  ...
  data() {
    return {
      ...
      showApprovedChat: false, //Control chart modal visibility
