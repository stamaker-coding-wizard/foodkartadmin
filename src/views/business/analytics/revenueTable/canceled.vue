<template>
    <div>
        ...
        <!--Adding Chart Modal -->
        <b-modal v-model="showCanceledChat" size="lg">
          <CanceledChat/>
        </b-modal>
    </div>
</template>
...
import CanceledChat from "./chat/Canceled.vue";
...
export default {
  ...
  data() {
    return {
      ...
      showCanceledChat: false, //Control chart modal visibility
