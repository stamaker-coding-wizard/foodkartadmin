<template>
    <div>
        ...
        <!--Adding Chart Modal -->
        <b-modal v-model="showPendingChat" size="lg">
          <PendingChat/>
        </b-modal>
    </div>
</template>
...
import PendingChat from "./chat/Pending.vue";
...
export default {
  ...
  data() {
    return {
      ...
      showPendingChat: false, //Control chart modal visibility
