<template>
    <div>
        ...
        <b-row>
            <!-- ICON BG -->
            <b-col lg="3" md="6" sm="12" v-for="drink in drinks" :key="drink.Content" style="cursor:pointer;" class="categoryBox">
                
            <b-card
                class=" o-hidden mb-30 categoryCard"
            >
                <p class="status">{{ drink.status }} </p>
                <div class="cateUrl">
                    <img :src="drink.Url">
                </div>
                <div class="cateContent">
                <div class="namePrice">
                    <h6 class="name">{{ drink.name }} </h6>
                    <h4 class="price">{{ drink.price}}</h4>
                </div>
                    <!--
                <div class="actions">
                ...
                <div class="actions">
                    <h5><span class="vendor">Vendor:</span> <span class="vendorN"> {{ drink.vendor }} <a class="text-success mr-2 ml-2" @click="addChatRow(index)" style="cursor:pointer;"><i class="nav-icon i-Speach-Bubble-3 font-weight-bold"></i></a> </span> </h5>
                </div>
      ...
      <b-modal v-model="showEditModal" title="Edit Row">
        <form @submit.prevent="updateTableRow">
          ...
          <div class="form-group">
            <label for="editdrinkstatus">Food Status</label>
      ...
      <b-modal v-model="showDrinksChart" size="lg">
        <DrinksChat/>
      </b-modal>
    </div>
</template>
...
import DrinksChat from "./chat/Products.vue";
export default {
    name: 'Foods',
    components: {
    ...
    data(){
        return{
            ...
            showDrinksChart: false, //Control chart modal visibility
            ...
            drinks: [
                {Url: require("@/assets/images/products/drinks/drink9.png"), name:"Soft Drink", status:"Sale", price: "1000", vendor: "Sarah"},
                {Url: require("@/assets/images/products/drinks/drink10.png"), name:"Soft Drink", status:"Sale", price: "900", vendor: "Joshua" },
                {Url: require("@/assets/images/products/drinks/drink11.png"), name:"Pepsi", status:"Sale", price: "600", vendor: "Samuel" },
                {Url: require("@/assets/images/products/drinks/drink12.png"), name:"Fanta", status:"Not Available", price: "400", vendor: "Olayinka" },
                {Url: require("@/assets/images/products/drinks/drink13.png"), name:"Limca", status:"Sale", price: "300", vendor: "Joshua"},
                {Url: require("@/assets/images/products/drinks/drink14.png"), name:"Mirinda", status:"Sale", price: "400", vendor: "Joshua" },
                {Url: require("@/assets/images/products/drinks/drink15.png"), name:"Pepsi", status:"Sale", price: "500", vendor: "Joshua" },
                {Url: require("@/assets/images/products/drinks/drink16.png"), name:"Fanta", status:"Not Available", price: "400", vendor: "Joshua" },
                {Url: require("@/assets/images/products/drinks/drink17.png"), name:"Fanta", status:"Not Available", price: "500", vendor: "Joshua" },
                {Url: require("@/assets/images/products/drinks/drink18.png"), name:"Limca", status:"Sale", price: "300", vendor: "Joshua"},
                {Url: require("@/assets/images/products/drinks/drink19.png"), name:"Mirinda", status:"Sale", price: "200", vendor: "John" },
                {Url: require("@/assets/images/products/drinks/drink20.png"), name:"Pepsi", status:"Sale", price: "400", vendor: "Taofeek" },
                {Url: require("@/assets/images/products/drinks/drink21.png"), name:"Fanta", status:"Not Available", price: "250", vendor: "Bintu" },
...
editRow(index) {
  ...
  this.editRowData = { ...this.drinks[index] };
...
updateTableRow() {
  ...
  if (this.editRowIndex !== -1) {
    this.foods[this.editRowIndex] = { ...this.editRowData };
  }
...
addTableRow() {
  ...
  this.drinks.push({ ...this.newRow, id: this.drinks.length + 1 });
