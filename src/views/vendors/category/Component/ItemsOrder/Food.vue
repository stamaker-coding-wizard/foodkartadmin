<template>
    <div>
        ...
        <b-row>
            <!-- ICON BG -->
            <b-col lg="3" md="6" sm="12" v-for="food in foods" :key="food.Content" style="cursor:pointer;" class="categoryBox">
                
            <b-card
                class=" o-hidden mb-30 categoryCard"
            >
                <p class="status">{{ food.status }} </p>
                <div class="cateUrl">
                    <img :src="food.Url">
                </div>
                ...
                <!--
                  ...
                  <div class="actions">
                    <h5><span class="vendor">Vendor:</span> <span class="vendorN"> {{ food.vendor }}<a class="text-success mr-2 ml-2" @click="addChatRow(index)" style="cursor:pointer;"><i class="nav-icon i-Speach-Bubble-3 font-weight-bold"></i></a> </span> </h5>
      ...
      <b-modal v-model="showFoodChart" size="lg">
        <FoodChat/>
      </b-modal>
    </div>
</template>
...
import FoodChat from "./chat/Products.vue";
export default {
    name: 'Foods',
    components: {
    ...
    data(){
        return{
            ...
            showFoodChart: false, //Control chart modal visibility
            ...
            foods: [
                {Url: require("@/assets/images/products/foodkart7-removebg-preview.png"), name:"Beans and Dodo", status:"Sale",  price: "1000", vendor: "Sarah"},
                {Url: require("@/assets/images/products/jollofRice-removebg-preview.png"), name:"Jollof Rice", status:"Sale", price: "2000", vendor: "Sarah" },
                {Url: require("@/assets/images/products/foodkart2-removebg-preview.png"), name:"Amala and Soup", status:"Sale",price: "1000", vendor: "Tomi" },
                {Url: require("@/assets/images/products/BreadBeans-removebg-preview.png"), name:"Bread and Beans", status:"Not Available", price: "900", vendor: "Ewa"},
                {Url: require("@/assets/images/products/foodkart7-removebg-preview.png"), name:"Beans and Dodo", status:"Sale",  price: "4000", vendor: "Taofeek"},
                {Url: require("@/assets/images/products/jollofRice-removebg-preview.png"), name:"Jollof Rice", status:"Sale",price: "5000", vendor: "Ayomide" },
                {Url: require("@/assets/images/products/foodkart2-removebg-preview.png"), name:"Amala and Soup", status:"Sale", price: "6000", vendor: "Bobo"},
                {Url: require("@/assets/images/products/BreadBeans-removebg-preview.png"), name:"Bread and Beans", status:"Not Available", price: "7000", vendor: "Bamidele"},
...
editRow(index) {
  ...
  this.editRowData = { ...this.foods[index] };
...
addTableRow() {
  ...
  this.foods.push({ ...this.newRow, id: this.foods.length + 1 });
